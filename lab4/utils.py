...
def get_page_ids_for_termin(termin):
    with open(os.path.join(INDEX_DIR, 'reverse_index'), 'rb') as reverse_index, \
         open(os.path.join(INDEX_DIR, 'dictionary'), 'rb') as dictionary, \
         open(os.path.join(INDEX_DIR, 'right_index'), 'rb') as right_index:
...
def get_page_by_id(dock_id):
    with open(os.path.join(INDEX_DIR, "right_index"), 'rb') as right_index:
